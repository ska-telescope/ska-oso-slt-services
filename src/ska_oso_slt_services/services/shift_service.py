...
from ska_oso_slt_services.repositories.abstract_base import ShiftRepository, CRUDShiftRepository


class ShiftService:
    def __init__(self, shift_repositories: Optional[List[ShiftRepository]], crud_shift_repository: CRUDShiftRepository):
        self.shift_repositories = shift_repositories
        self.crud_shift_repository = crud_shift_repository

    def getShifts(self, shift_start: Optional[datetime] = None, shift_end: Optional[datetime] = None) -> List[Shift]:
