...
class TestSLTAPI:
    ...
    # @mock.patch("ska_oso_slt_services.infrastructure.postgresql.insert")
    ...
    def test_get_shift_data(self, mock_slt, client):
        ...
        result = client.get(
            f"{BASE_API_URL}/shift/history?shift_start_time=2024-07-12T15%3A43%3A53.971548%2B00%3A00&shift_end_time=2024-07-24T15%3A43%3A53.971548%2B00%3A00",
            json=data,
            headers={"accept": "application/json"},
        )
